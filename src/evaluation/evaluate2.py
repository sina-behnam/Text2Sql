...
from src.loaders.mongo import MongoDBDataLoader
...
def save_to_mongo(instances_predictions: List[ModelsPredictionsPerInstance], 
    ...
    mongo_loader = MongoDBDataLoader(db_name=mongo_config.db_name, 
...
def evaluate(dataset_path: str = BIRD_DATA_PATH,
    ...
    mongo_loader = MongoDBDataLoader(**mongo_config.model_dump())
